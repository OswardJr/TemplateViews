            ...
            <div class="page-container">
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="heading">
                                <h3 class="uppercase">Registros</h3>
                            </li>
                            <li class="nav-item">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="fa fa-plus"></i>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="registroClien.html" target="" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    ...
                                    <span class="title">Compañias de Seguro</span>
                                    <span class="arrow "></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">
                                            <i class="fa fa-camera"></i>  Seguridad
                                        </a>
                                    </li>     
                                </ul>
                            </li>
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Bienvenidos al Sistema Automatizado Gandocam, C.A </h1>

                    <section class="content">
                        <img src="../assets/layouts/layout/img//one.png" style="width:720px; margin-left:160px"
                    </section>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
