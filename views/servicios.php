            ...
            ?>
                <div class="page-content-wrapper" style="">
                    ...
                    <div class="container">
                            <h2>Nueva Orden de Servicio - Aseguradoras</h2><hr style="width:70%">
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-primary ">
                                ...
                                <div class="form-group col-xs-1" style="margin-right:-20px">
                                  <div class="btn btn-primary fa fa-shopping-cart btn-agregar-producto" onClick="" style="margin-top:25px"> Añadir</div>
                                </div>
                                </div>
                                <input type="hidden" name="" value="" />
                              </div>
